                ...
                case GameStates.Playing:
                    {     
                        ...
                        if (debugText)
                        {
                            ...
                            spriteBatch.DrawString(FontLibrary.debug, "Current cameraposition: " + (145 - (int)logic.levelLoader.cameraPosition.Y / logic.levelLoader.TileSize()) + "", new Vector2(1f, Settings.windowBounds.Y - FontLibrary.debug.LineSpacing * 9), Color.White);
                        }
                        break;
                    }
            }
