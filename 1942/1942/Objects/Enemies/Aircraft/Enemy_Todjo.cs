...
namespace _1942
{
    class Enemy_Todjo : FlyingObject
    {

        private float timeUntilNextShot;

        public Enemy_Todjo(Vector2 position)
        {
            ...
            layerDepth = 1f;
            color = Color.White;
            size = Settings.size_todjo;
            spriteEffect = SpriteEffects.None;
            texture = Texture2DLibrary.enemy_todjo;
            health = Settings.todjo_health;
            maxHealth = Settings.todjo_health;
            score = 10;
        }
