...
namespace _1942
{
    class Formation1c : BaseFormation
    {

        public Formation1c(Vector2 startingPos, bool mirrored)
        {
            ...
            enemyInFormationList.Add(new Enemy_Todjo(new Vector2(startingPos.X, startingPos.Y - 45)));
            enemyInFormationList.Add(new Enemy_Todjo(new Vector2(startingPos.X, startingPos.Y - 90)));
