...
namespace _1942
{
    class Formation1b : BaseFormation
    {



        public Formation1b(Vector2 startingPos, bool mirrored)
        {
            ...
            enemyInFormationList.Add(new Enemy_Zeke(new Vector2(startingPos.X, startingPos.Y - 45)));
            enemyInFormationList.Add(new Enemy_Zeke(new Vector2(startingPos.X, startingPos.Y - 90)));
